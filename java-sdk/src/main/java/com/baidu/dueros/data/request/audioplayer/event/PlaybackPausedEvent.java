...
@JsonTypeName("AudioPlayer.PlaybackPaused")
public class PlaybackPausedEvent extends AudioPlayerEvent {
    ...
    public static final class Builder extends RequestBodyBuilder<Builder, PlaybackPausedEvent> {
        ...
        /**
         * 调用{@code PlaybackFinishedEvent}的私有构造方法构造{@code PlaybackPausedEvent}
         * 
