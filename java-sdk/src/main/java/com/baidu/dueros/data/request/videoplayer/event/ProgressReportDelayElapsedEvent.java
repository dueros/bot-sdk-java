...
@JsonTypeName("VideoPlayer.ProgressReportDelayElapsed")
public class ProgressReportDelayElapsedEvent extends VideoPlayerEvent {
    ...
    private ProgressReportDelayElapsedEvent(final Builder builder) {
        super(builder);
        token = builder.token;
    ...
    public static final class Builder extends RequestBodyBuilder<Builder, ProgressReportDelayElapsedEvent> {
        ...
        /**
         * 调用{@code ProgressReportDelayElapsedEvent}的私有构造方法构造{@code ProgressReportDelayElapsedEvent}
         * 
