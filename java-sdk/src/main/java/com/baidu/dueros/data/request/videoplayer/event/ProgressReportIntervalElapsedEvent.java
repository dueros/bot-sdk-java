...
/**
 * 本事件用来统计播放情况。如果Play指令有progressReportIntervalInMilliseconds，则在播放对应video
 * item时，每隔此时间端上会上报本事件
 * 
...
@JsonTypeName("VideoPlayer.ProgressReportIntervalElapsed")
public class ProgressReportIntervalElapsedEvent extends VideoPlayerEvent {
     ...
     *            当前的播放进度
     */
    private ProgressReportIntervalElapsedEvent(@JsonProperty("requestId") final String requestId,
    ...
    private ProgressReportIntervalElapsedEvent(final Builder builder) {
        super(builder);
        token = builder.token;
    ...
    /**
     * 用来构造{@code ProgressReportIntervalElapsedEvent}
     * 
     * @author hujie08(hujie08@baidu.com)
     * @version V1.0
     * @since 2018年5月7日
    ...
    public static final class Builder extends RequestBodyBuilder<Builder, ProgressReportIntervalElapsedEvent> {
        ...
        /**
         * 调用{@code ProgressReportIntervalElapsedEvent}的私有构造方法构造{@code ProgressReportIntervalElapsedEvent}
         * 
