...
@JsonTypeName("Permission.GrantFailed")
public class PermissionGrantFailedEvent extends CommonEvent {
    // 对应支付指令的token
     ...
     */
    protected PermissionGrantFailedEvent(Builder builder) {
        super(builder);
     ...
     *            token
     */
    protected PermissionGrantFailedEvent(@JsonProperty("requestId") final String requestId,
     ...
     * @since 2018年5月3日
     */
    public static final class Builder extends RequestBodyBuilder<Builder, PermissionGrantFailedEvent> {
        ...
        @Override
        public PermissionGrantFailedEvent build() {
            return new PermissionGrantFailedEvent(this);
        }
