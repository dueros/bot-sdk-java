...
@JsonTypeName("AudioPlayer.PlaybackResumed")
public class PlaybackResumedEvent extends AudioPlayerEvent {
    ...
    public static final class Builder extends RequestBodyBuilder<Builder, PlaybackResumedEvent> {
        ...
        /**
         * 调用{@code PlaybackFinishedEvent}的私有构造方法构造{@code PlaybackResumedEvent}
         * 
