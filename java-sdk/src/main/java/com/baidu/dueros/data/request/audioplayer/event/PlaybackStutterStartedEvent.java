...
@JsonTypeName("AudioPlayer.PlaybackStutterStarted")
public class PlaybackStutterStartedEvent extends AudioPlayerEvent {
    ...
    public PlaybackStutterStartedEvent(Builder builder) {
        super(builder);
        token = builder.token;
