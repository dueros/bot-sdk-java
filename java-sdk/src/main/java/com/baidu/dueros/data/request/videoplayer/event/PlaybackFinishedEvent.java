...
@JsonTypeName("VideoPlayer.PlaybackFinished")
public class PlaybackFinishedEvent extends VideoPlayerEvent {
    // 对应到播放的视频id
    ...
    /**
     * 返回一个用来构造{@code PlaybackFinishedEvent}的{@code Builder}
     * 
     * @return Builder 用来构造{@code PlaybackFinishedEvent}
     */
    ...
    private PlaybackFinishedEvent(final Builder builder) {
        super(builder);
        token = builder.token;
    ...
    /**
     * 用来构造{@code PlaybackFinishedEvent}
     * 
     * @author hujie08(hujie08@baidu.com)
     * @version V1.0
     * @since 2018年5月7日
     */
    public static final class Builder extends RequestBodyBuilder<Builder, PlaybackFinishedEvent> {
        ...
        /**
         * 调用{@code PlaybackFinishedEvent}的私有构造方法构造{@code PlaybackFinishedEvent}
         * 
         * @see com.baidu.dueros.data.request.RequestBody.RequestBodyBuilder#build()
         */
        public PlaybackFinishedEvent build() {
            return new PlaybackFinishedEvent(this);
        }
    }
}
