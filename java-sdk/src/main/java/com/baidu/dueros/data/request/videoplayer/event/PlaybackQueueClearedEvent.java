...
@JsonTypeName("VideoPlayer.PlaybackQueueCleared")
public class PlaybackQueueClearedEvent extends VideoPlayerEvent {
    // 对应到播放的视频id
    ...
    /**
     * 返回一个用来构造{@code PlaybackQueueClearedEvent}的{@code Builder}
     * 
     * @return Builder 用来构造{@code PlaybackQueueClearedEvent}
     */
    ...
    private PlaybackQueueClearedEvent(final Builder builder) {
        super(builder);
        token = builder.token;
    ...
    /**
     * 用来构造{@code PlaybackQueueClearedEvent}
     * 
     * @author hujie08(hujie08@baidu.com)
     * @version V1.0
     * @since 2018年5月7日
     */
    public static final class Builder extends RequestBodyBuilder<Builder, PlaybackQueueClearedEvent> {
         ...
         */
        public PlaybackQueueClearedEvent build() {
            return new PlaybackQueueClearedEvent(this);
        }
    }
