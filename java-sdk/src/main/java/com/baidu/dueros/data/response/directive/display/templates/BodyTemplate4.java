...
/**
 * 定义图片文本展现模板，图片在文字内容右侧，即右图左文
 * 
 * @author hujie08(hujie08@baidu.com)
 * @version 1.0
 * @since 2018年4月27日
 */
@JsonTypeName("BodyTemplate4")
@JsonIgnoreProperties(ignoreUnknown = true)
public class BodyTemplate4 extends TextImageTemplate {
    /**
     * 构造函数
     */
    public BodyTemplate4() {
    }
     ...
     *            文字内容
     */
    public BodyTemplate4(String title, TextType textType, String text) {
